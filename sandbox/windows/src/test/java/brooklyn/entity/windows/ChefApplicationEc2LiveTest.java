...
public class ChefApplicationEc2LiveTest {
    ...
    protected void doTest(Location loc) throws Exception {
        ChefApplication webapp = app.createAndManageChild(EntitySpecs.spec(ChefApplication.class)
                .configure(ChefApplication.COOKBOOKS_ZIPFILE, "/Users/richard/tmp/chef-windows.zip")
        );
